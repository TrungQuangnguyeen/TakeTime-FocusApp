...
Write-Host ""
Write-Host "Enhanced AppBlockingService:" -ForegroundColor Green
Write-Host "  - Dual detection method (getRunningTasks + UsageStatsManager)" -ForegroundColor White
Write-Host "  - Faster monitoring (1 second interval)" -ForegroundColor White
Write-Host "  - Improved blocking with force close" -ForegroundColor White
Write-Host "  - Continuous monitoring to prevent reopening" -ForegroundColor White
Write-Host ""
Write-Host "Enhanced AppBlockedActivity:" -ForegroundColor Green
Write-Host "  - Stronger window flags to prevent dismissal" -ForegroundColor White
Write-Host "  - Window focus protection" -ForegroundColor White
Write-Host "  - Automatic restart when focus lost" -ForegroundColor White
Write-Host ""
